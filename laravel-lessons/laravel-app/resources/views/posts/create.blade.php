...
@section('content')
    <h1 style="margin-bottom: 1.5rem; color: #333;">新規投稿</h1>
    ...
    <form action="{{ route('posts.store') }}" method="POST" style="max-width: 600px;">
        ...
        <div style="margin-bottom: 1rem;">
            ...
            <textarea id="content" 
                      ...
                      rows="6" 
                      required
                      style="width: 100%; padding: 0.75rem; border: 1px solid #dee2e6; border-radius: 4px; font-size: 1rem; resize: vertical;"></textarea>
        </div>
